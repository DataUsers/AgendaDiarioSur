...
public class Busqueda implements Serializable {
	...
	try {
		...
		eventosMostrar = negocio.busquedaEventos(currentPage, MAX_EVENTO, filtros, queryString, latitud, longitud, filtrarMasVisitados);
	    } else {
		// si no tiene latitud y longitud
		eventosMostrar = negocio.busquedaEventos(currentPage, MAX_EVENTO, filtros, queryString, filtrarMasVisitados);
	    }
